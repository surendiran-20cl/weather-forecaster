...
import com.mmnabi.weatherproject.common.services.WeatherService;
...
public class WeatherServiceHelper {
    ...
    public void getCurrentWeather(Double lat, Double lon) {
        String url, unitName = MainActivity.UNIT_SELECTED;
        // &units=metric
    ...
    public void getCurrentWeather(String city) {
        String url, cityName, unitName = MainActivity.UNIT_SELECTED;
        cityName = city;
        url = ENDPOINT_URL_CURRENT_WEATHER_DATA
                + "q="
                + cityName
    ...
    public void getForecastWeather() {
        String url, cityName = CurrentWeatherFragment.cityName,
                unitName = MainActivity.UNIT_SELECTED;
        // &units=metric
        url = ENDPOINT_URL_FORECAST_WEATHER_DATA
                ...
                + unitName
                + "&cnt="
                + MainActivity.FORECAST_LIMIT_SELECTED
                + "&appid="
                + API_KEY;
